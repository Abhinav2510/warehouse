package com.ikea.inventory.warehouse.service;
...
import com.ikea.inventory.warehouse.repos.InventoryArticleRepo;
import com.ikea.inventory.warehouse.repos.InventoryProductRepo;
...
public class InventoryServiceTest {
    ...
    public void test_InsertProductAndDependencies_Test_Quantities() {
        ...
        System.out.println(productIdArgs);
        System.out.println(quantityArgs);
    ...
    @Test
    public void test_updateProductSales_Test_Quantities() {
        ...
        Mockito.when(inventoryArticleRepo.findById(Mockito.eq(2L))).thenReturn(Optional.of(article2));

        inventoryService.updateProductSales(1,2);
        ...
        System.out.println(productIdArgs);
        System.out.println(quantityArgs);
        assertTrue(quantityArgs.containsAll(Arrays.asList(0L,0L)));
        assertTrue(productIdArgs.containsAll(Arrays.asList(1L,2L)));
